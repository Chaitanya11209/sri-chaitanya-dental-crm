...
const DEFAULT_LABS: LabRequest[] = [
  { id: '1', patientName: 'Sushma Reddy', testName: 'Biopsy Oral Tissue Histology', doctorName: 'Dr. Durga Bhavani Jupalli (BDS, Cosmetic Dental Surgeon)', status: 'In Process', priority: 'Urgent', date: '2026-06-15', notes: 'Check for dysplastic margins round lower left molar.' },
  { id: '2', patientName: 'Aditya Sharma', testName: 'Panoramic Dental Radiograph (OPG)', doctorName: 'Dr. Durga Bhavani Jupalli (BDS, Cosmetic Dental Surgeon)', status: 'Report Uploaded', priority: 'Routine', date: '2026-06-14', notes: 'Evaluate wisdom tooth impaction angle.', testResult: 'Class II Horizontal tooth impaction on Lower Right jaw. Mild pericoronitis noted.' },
  ...
  { id: '4', patientName: 'Nagarjuna Rao', testName: 'CBCT Cone Beam Dental CT', doctorName: 'Dr. Durga Bhavani Jupalli (BDS, Cosmetic Dental Surgeon)', status: 'Report Uploaded', priority: 'Urgent', date: '2026-06-12', notes: 'Verify exact bone density before implant healing placement.', testResult: 'Alveolar ridge width is 6.5mm with Type II bone qualities. Safe for implant.' }
];
...
export default function LabWork() {
  ...
  const [newDoctor, setNewDoctor] = useState('Dr. Durga Bhavani Jupalli (BDS, Cosmetic Dental Surgeon)');
            ...
            <form onSubmit={handleAddLab} className="p-5 space-y-4 font-sans text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  >
                    <option value="Dr. Durga Bhavani Jupalli (BDS, Cosmetic Dental Surgeon)">Dr. Durga Bhavani Jupalli (BDS, Cosmetic Dental Surgeon)</option>

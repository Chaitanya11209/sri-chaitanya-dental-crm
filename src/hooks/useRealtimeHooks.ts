...
export function usePatientsRealtime() {
  ...
  const fetchPatients = useCallback(async () => {
    try {
      ...
      console.warn("[Database → Query → Hook] [Patients] Fetch failed:", err);
...
export function useAppointmentsRealtime() {
  ...
  const fetchAppointments = useCallback(async () => {
    try {
      ...
      console.warn("[Database → Query → Hook] [Appointments] Fetch failed:", err);
...
export function useBillingRealtime() {
  ...
  const fetchBilling = useCallback(async () => {
    try {
      ...
      console.warn("[Database → Query → Hook] [Billing] Fetch failed:", err);
...
export function useTreatmentsRealtime() {
  ...
  const fetchTreatments = useCallback(async () => {
    try {
      ...
      console.warn("[Database → Query → Hook] [Treatments] Fetch failed:", err);

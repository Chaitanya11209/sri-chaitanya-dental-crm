...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: Facebook, href: clinicConfig.socialLinks.facebook, label: 'Facebook' },
    { icon: Instagram, href: clinicConfig.socialLinks.instagram, label: 'Instagram' },
    { icon: Twitter, href: clinicConfig.socialLinks.twitter, label: 'Twitter' },
    { icon: Linkedin, href: clinicConfig.socialLinks.linkedin, label: 'LinkedIn' },
    { icon: Youtube, href: clinicConfig.socialLinks.youtube, label: 'YouTube' },
  ].filter((social) => Boolean(social.href && social.href.trim() !== '' && social.href !== '#'));
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li className="flex items-center gap-2.5 sm:gap-3">
                ...
                <a href={`tel:${clinicConfig.phone.replace(/\s+/g, '')}`} className="text-slate-400 hover:text-teal-400 transition-colors text-xs sm:text-sm">
                  {clinicConfig.phone}
                </a>
              </li>
              <li className="flex items-center gap-2.5 sm:gap-3">
                ...
                <a href={`mailto:${clinicConfig.email}`} className="text-slate-400 hover:text-teal-400 transition-colors text-xs sm:text-sm break-all">
                  {clinicConfig.email}
                </a>
              </li>
            </ul>

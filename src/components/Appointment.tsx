...
const services = DENTAL_PROBLEMS;
...
export default function Appointment() {
  ...
  const validateField = (name: string, value: string) => {
    ...
    if (name === 'name') {
      ...
      } else if (!isValidAppointmentTime(value)) {
        error = 'Please select a valid time between 5:00 AM and 11:00 PM.';
      }
    }
    return error;
  };
...
Please contact the patient to confirm the appointment.`;
  ...
  <div>
    <ReasonForVisitSelect
      ...
      required
      label="Reason for Visit / Service Required *"

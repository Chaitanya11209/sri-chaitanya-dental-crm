...
export function NotificationProvider({ children }: { children: ReactNode }) {
  ...
  const notify = useCallback((type: NotificationType, title: string, description: string, details?: string) => {
    ...
    // Schedule state update on next event loop tick to prevent "Cannot update a component while rendering a different component" error
    setTimeout(() => {
